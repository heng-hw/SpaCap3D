...
class Pointnet2Backbone(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        pointcloud = data_dict["point_clouds"]  # b,n,3+128+1

        xyz, features = self._break_up_pc(pointcloud)  # xyz: b,n,3 features: b,129, n
        ...
        data_dict['fp2_features'] = features  # torch.Size([8, 256, 1024])
        data_dict['fp2_xyz'] = data_dict['sa2_xyz']  # torch.Size([8, 1024, 3])
