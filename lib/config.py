...
# path
CONF.PATH = EasyDict()
CONF.PATH.BASE = "/home/heng/heng/code-repo/SpaCap3D/" # TODO: change this
CONF.PATH.CLUSTER = "/home/heng/heng/code-repo/SpaCap3D/" # TODO: change this
...
# data
CONF.SCANNET_FRAMES_ROOT = os.path.join(CONF.PATH.DATA, "scannet_train_images/frames_square/")
CONF.ENET_FEATURES_ROOT = os.path.join(CONF.PATH.DATA, "scannet_train_images/enet_features")
