...
SCANNET_LIST = CONF.SCANNETV2_LIST  # "scannetv2.txt"
...
def get_scene_data(scene_list):
    ...
    for scene_id in scene_list:
        ...
        try:
            ...
            continue
    print('#scene data is', len(scene_data))  # 1513
    return scene_data
...
if __name__ == "__main__":
    ...
    scene_list = get_scene_list()  # 1613
    print('#scene list is', len(scene_list))
    ...
    with h5py.File(ENET_FEATURE_DATABASE, "w", libver="latest") as database:
        ...
        for scene_id in scene_list:
            ...
            try:
                ...
                print('scene', scene_id, ' not existed')
                continue
            # load frames
            frame_list = list(
