...
def export(mesh_file, agg_file, seg_file, meta_file, label_map_file, output_file=None, save_aligned_mesh=False):
    ...
    mesh_vertices, mesh_face = scannet_utils.read_mesh_vertices_rgb_normal(mesh_file)
    ...
    # save axis-aligned mesh
    if save_aligned_mesh:
        mesh = scannet_utils.export_mesh(aligned_vertices, mesh_face)
        mesh.write(mesh_file.replace('_vh_clean_2.ply', '_axis_aligned.ply'))
